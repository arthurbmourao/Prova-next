...
export default function CursoDetalhes ({card} : CardCursoProps){
    return(
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-[1.35fr_0.65fr]">
          <div>
            {card.destaque ? "<p className=mb-3 text-xs font-extrabold uppercase tracking-[0.16em] text-weg-blue>Curso em destaque</p>" : "<span class=inline-flex rounded-full bg-weg-light px-3 py-1 text-xs font-extrabold uppercase tracking-wide text-weg-dark>Curso</span>"}
          ...
          <aside className="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-5 text-3xl font-extrabold tracking-tight text-weg-dark">R$ ${card.preco.toFixed(2)}</p>
